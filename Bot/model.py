...
from torch_geometric.nn import RGCNConv,FastRGCNConv,GCNConv,GATConv,TransformerConv,SGConv
...
class BotGAT(nn.Module):
    def __init__(self,des_size=768,tweet_size=768,num_prop_size=6,cat_prop_size=11,embedding_dimension=128,dropout=0.3):
        ...
        self.gat1=GATConv(embedding_dimension,int(embedding_dimension/8),heads=8)
...
class BotBCN(nn.Module):
    def __init__(self, des_size=768, tweet_size=768, num_prop_size=6, cat_prop_size=11, embedding_dimension=128,
                 dropout=0.3):
        super(BotBCN, self).__init__()
        self.dropout = dropout
        self.linear_relu_des = nn.Sequential(
            nn.Linear(des_size, int(embedding_dimension / 4)),
            nn.LeakyReLU()
        ...
        self.gcn1 = BEConv(embedding_dimension, embedding_dimension)
        self.gcn2 = BEConv(embedding_dimension, embedding_dimension)
...
class BotRGAT(nn.Module):
    def __init__(self, des_size=768, tweet_size=768, num_prop_size=6, cat_prop_size=11, embedding_dimension=128,
                 dropout=0.3):
        super(BotRGAT, self).__init__()
        self.dropout = dropout
        self.linear_relu_des = nn.Sequential(
            nn.Linear(des_size, int(embedding_dimension / 4)),
            nn.LeakyReLU()
        ...
        self.gat1 = TransformerConv(embedding_dimension, int(embedding_dimension / 8), heads=8)
        self.gat2 = TransformerConv(embedding_dimension, embedding_dimension)
...
class BotSGC(nn.Module):
    def __init__(self, des_size=768, tweet_size=768, num_prop_size=6, cat_prop_size=11, embedding_dimension=128,
                 dropout=0.3):
        super(BotSGC, self).__init__()
        self.dropout = dropout
        self.linear_relu_des = nn.Sequential(
            nn.Linear(des_size, int(embedding_dimension / 4)),
            nn.LeakyReLU()
        ...
        self.gcn1 = SGConv(embedding_dimension, embedding_dimension,K=3)
        self.gcn2 = SGConv(embedding_dimension, embedding_dimension,K=3)
